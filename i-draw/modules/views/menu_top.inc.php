     <div class="menu">
        ...
        <tr style="height:30px;">
            ...
            <td colspan="2" style="text-align:center;padding-left:14px;">
                <p class="name-tag" style="cursor :context-menu;color:<?php echo $level_color?>;font-size: larger;">Hi! &nbsp;<?php echo $user['account_name'];?>&nbsp;
        ...
        <tr style="height:30px;">
            <td style="width:75%"><p style="margin-top: 0px;cursor :context-menu;">Let's show your draw picture.</p></td>
            <td style="border-top-left-radius: 12px;border-bottom-left-radius: 12px;background-color:rgb(18, 0, 68);border-width:0px;">
                <div align="center" style="width:200px;margin: auto;">
                    <a href="?app=user&action=profile&profile_id=<?php echo $user['id'];?>"><input class="btn-green" readonly value="Profile"></a>
                </div>
            </td>
