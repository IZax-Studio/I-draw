     <div class="menu">
        ...
        <tr style="height:30px;">
            ...
            <td colspan="2" style="text-align:center;padding-left:14px;">
                <a style="text-decoration: none;" href="?app=user&action=profile&profile_id=<?php echo $user['id'];?>">
        ...
        <tr style="height:30px;">
            ...
            <td style="border-top-left-radius: 12px;border-bottom-left-radius: 12px;background-color:rgb(18, 0, 68);border-width:0px;">
                <div align="center" style="width:200px;margin: auto;">
                    <a href="?app=user&action=profile&profile_id=<?php echo $user['id'];?>"><input class="btn-green" readonly value="Edit profile"></a>
                </div>
            </td>
